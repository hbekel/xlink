...
#define  USB_CFG_VENDOR_ID       USB_VID
 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       USB_PID
 ...
 */
#define USB_CFG_VENDOR_NAME     USB_MANUFACTURER
#define USB_CFG_VENDOR_NAME_LEN USB_MANUFACTURER_LENGTH
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     USB_PRODUCT
#define USB_CFG_DEVICE_NAME_LEN USB_PRODUCT_LENGTH
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER     USB_SERIAL
#define USB_CFG_SERIAL_NUMBER_LEN USB_SERIAL_LENGTH
